  ...
  return (
    ...
    >
      ...
      <div className="text-center text-white mb-8">
        <h1 className="text-[20px] font-bold">Iniciar sesión en W3</h1>
      ...
      <div className="w-[296px] bg-[#202020] shadow-md rounded-md flex flex-col gap-6 p-6">
        ...
        <Button
          ...
          onClick={handleLogin}
          fullWidth={true}
          className="bg-[#FAFAFA] text-[#202022] font-bold"
          disabled={!isFormValid}
        />
      </div>

      {/* Separador de redes sociales */}
      <div className="w-full text-center text-[#FEF7FF] text-[14px] font-semibold my-6">
      ...
      <div className="flex flex-col gap-4 w-[296px]">
        <Button
          ...
          fullWidth={true}
          className="bg-white text-[#202020] font-semibold"
        />
        <Button
          label="Registrarse con Facebook"
          onClick={() => console.log("Facebook login")}
          fullWidth={true}
          className="bg-[#3B5998] text-white font-semibold"
        />
      </div>

      {/* Registro */}
      <div className="text-center mt-6 text-[#FAFAFA] text-[14px] font-semibold">
